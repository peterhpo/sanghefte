...
\beginsong{EN BAYER I HÅNDEN}[by={Tekst: Kalle Zwilgmeyer \newline Melodi: Gutav Winckler}]
\beginverse
...
\beginsong{DET ER MEG DET SAMME HVOR JEG HAVNER NÅR JEG DØR}[by={Tekst: Mogens Lorentzen -- Melodi: Trad}]
\beginverse
...
\beginsong{NU KLINGER IGJENNOM DEN GAMLE STAD}[by={Tekst: Frode Rinnan \newline Melodi: William Steffe
